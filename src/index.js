...
MetadataService.prototype._resolveMetadata = function (metadata: Object[], tasks: Object, t: number, i?: number) {
  const hashes = []
  const idxs = []
...
MetadataService.prototype._generateLinkedData = function (ordered: Object, sender: Object, recipient: Object|Object[], tasks: Object, t: number, i?: number) {
...
MetadataService.prototype._import = function (metadata: Object[], sender: Object, recipient: Object|Object[], tasks: Object, t: number, i?: number) {
  this._hashes = {}
...
MetadataService.prototype._put = function (sender: Object, tasks: Object, t: number, i?: number) {
  const hashes = this._hashes
...
MetadataService.prototype.importLinkedData = function (ld: Object) {
  this._ld = ld
}
...
ContentService.prototype._get = function (path: string, decrypt: Object, tasks: Object, t: number, i?: number) {
...
ContentService.prototype._exportDecryption = function (): Object {
...
ContentService.prototype._exportHashes = function (): Object {
  return this._hashes || {}
}
...
function Project({ account, contentService, metadataService, title }: Object) {
...
Project.prototype._import = function (content: Object[], metadata: Object[], password: string, tasks: Object, t: number, i?: number) {
  const account = this._account
...
Project.prototype._upload = function (password: string, tasks: Object, t: number, i?: number) {
  const account = this._account
  const contentService = this._contentService
  const metadataService = this._metadataService
  let t1, t2
...
Project.prototype._export = function (name: string): Object|Object[] {
  const contentService = this._contentService
  const metadataService = this._metadataService
  switch (name) {
...
Project.prototype.upload = function (password: string, cb: Function) {
...
Project.prototype.import = function (content: Object[], metadata: Object[], password: string, cb: Function) {
  if (typeof password === 'function') {
    [cb, password] = [password, '']
  } else if (!cb) {
    throw ErrNoCallback
